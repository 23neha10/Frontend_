        ...
        public  LoginModel UserAuth(LoginModel loginModel)
        {
            ...
            using(SqlConnection cn = new SqlConnection(scn))
            {
...

                {
                    ...
                    cmd.Parameters.Add("@UserEmail", System.Data.SqlDbType.VarChar, 40).Value = loginModel.UserEmail; //another way pass data
                    cmd.Parameters.Add("@UserPassword", System.Data.SqlDbType.VarChar, 20).Value = loginModel.UserPassword;
